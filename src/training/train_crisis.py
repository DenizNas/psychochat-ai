...
def main():
    parser = argparse.ArgumentParser(description="Train Crisis Classification Model")
    parser.add_argument("--data", type=str, default="data/processed/crisis_dataset_final.csv", help="Path to csv")
    ...
    parser.add_argument("--save_dir", type=str, default="models/crisis_model", help="Path to save the trained model")
    ...
    # 1. Load data
    print("Loading crisis data and creating splits...")
    ...
    print("Initializing Crisis Model and Tokenizer...")
    ...
    # 6. Train model
    print("Starting Training Loop for Crisis Model...")
    ...
    print("Crisis Model Training Pipeline Finished Successfully!")
